...
// Problem 1
// find who donate more than 100 dollars
let moreThan100 = runners.filter(runner => runner.donation > 100);
console.log(moreThan100);
// Problem 2
// find runners whose email end with edu
let endWithEdu = runners.filter(runner => runner.email.endsWith("edu"));
